 ...
 * @author aluno
 */
public class NewBuscaCliente extends javax.swing.JFrame {

    /**
     * Creates new form NewModelBuscar
     */
    public NewBuscaCliente() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewBuscaCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewBuscaCliente().setVisible(true);
            }
        });
    }
