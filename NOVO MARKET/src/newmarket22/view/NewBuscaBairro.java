 ...
 * @author aluno
 */
public class NewBuscaBairro extends javax.swing.JFrame {

    /**
     * Creates new form NewModelBuscar
     */
    public NewBuscaBairro() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableDadosAchados.setAutoCreateColumnsFromModel(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewBuscaBairro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewBuscaBairro().setVisible(true);
            }
        });
    }
